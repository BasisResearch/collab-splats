...
from nerfstudio.configs.datamanagers.base_datamanager import (
    TemplateDataManagerConfig,
)
from nerfstudio.configs.model.base_model import TemplateModelConfig
from nerfstudio.configs.pipeline.base_pipeline import TemplatePipelineConfig
