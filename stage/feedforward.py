...
class Reconstructor:
    ...
    def setup_feature_extractor(
        ...
        **kwargs,
        ...
        Args:
            name: Extractor name registered in BaseFeatureExtractor (e.g. "samclip", "dinov2").
        ...
        Example:
            >>> rec.setup_feature_extractor("samclip", device="cuda")
    ...
    def _extract_image_features(
        ...
        Handles both CLIP (samclip) and DINO (dinov2) extractors.
    ...
    def feedforward_to_pointcloud(
        ...
        Args:
            ...
            feature_extractor: Name of the feature extractor to use for semantic features
                               (e.g. "samclip", "dinov2"). If None, no features are extracted.
    ...
    def query_pointcloud(
        ...
        (e.g. "samclip"). Text embeddings are projected through the same PCA that was
        ...
        Example:
            >>> pcd = rec.feedforward_to_pointcloud(feature_extractor="samclip", n_components=64)
