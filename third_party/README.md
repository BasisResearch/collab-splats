...
| `xfeat/` | `verlab/accelerated_features` | `setup/feedforward.sh` | Lightweight local feature extractor for camera localization (`collab_splats/pointcloud/localization.py`). `sys.path` insert to `modules/`. |
