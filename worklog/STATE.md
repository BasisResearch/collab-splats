...
## In-Flight Work
- **gt-eval-harness** — [spec](docs/superpowers/specs/2026-05-07-gt-eval-harness-design.md) · [plan](docs/superpowers/plans/2026-05-07-gt-eval-harness.md) — status: wip
- **feedforward-import-cleanup** — [spec](docs/superpowers/specs/2026-05-08-feedforward-import-cleanup-design.md) · [plan](docs/superpowers/plans/2026-05-08-feedforward-import-cleanup.md) — status: wip
- **feedforward-mesh** — [spec](docs/superpowers/specs/2026-05-14-feedforward-mesh-design.md) · [plan](docs/superpowers/plans/2026-05-14-feedforward-mesh.md) — status: wip
- **docs-site** — [spec](docs/superpowers/specs/2026-05-20-docs-site-design.md) · [plan](docs/superpowers/plans/2026-05-20-docs-site.md) — status: wip (Sphinx docs site setup)
- **bae-vggt-parity** — [spec](docs/superpowers/specs/2026-05-20-bae-vggt-parity-design.md) — status: ready-for-handoff (verify our BA matches upstream `zitongzhan/vggt --implementation bae` on matched inputs)

## Recently Completed
- **ba-module-cleanup** (2026-05-24) — [spec](docs/superpowers/specs/2026-05-24-ba-module-cleanup-design.md) · [plan](docs/superpowers/plans/2026-05-24-ba-module-cleanup.md)
  - Hard imports for `torch`, `torch.nn`, `pypose`, `bae.*`, `vggt.*` at module top. Collapsed `_run_bundle_adjustment` (220 lines) into `BundleAdjustment._optimize()` — reads `self.config` directly. Lifted `ReprojNonBatched` inner class → module-level `_BAModel` with injected `shared_camera` flag. Lifted conditional closures → `_reproject_per_camera` / `_reproject_shared` with `@map_transform`. Removed dead `image_size` param; inlined `rotate_quat` as `pp.SE3(...).Act(pts)`. Reordered module: public API first. Updated tests: removed `image_size` call sites, patched `_optimize`, removed stale `bae.utils.ba.rotate_quat` mock. ~34% line reduction (438 → ~290 lines).
...
- **localization-cleanup** (2026-05-21) — [spec](docs/superpowers/specs/2026-05-21-localization-cleanup-design.md) · [plan](docs/superpowers/plans/2026-05-21-localization-cleanup.md)
...
- **feedforward-tutorial** (2026-05-21) — [spec](docs/superpowers/specs/2026-05-21-feedforward-notebook-design.md) · [plan](docs/superpowers/plans/2026-05-21-feedforward-notebook.md)
...
- **camera-localization** (2026-05-21) — [spec](docs/superpowers/specs/2026-05-21-camera-localization-design.md) · [plan](docs/superpowers/plans/2026-05-21-camera-localization.md)
...
- **keyframe-extraction-tutorial** (2026-05-21) — [spec](docs/superpowers/specs/2026-05-20-keyframe-extraction-tutorial-design.md) · [plan](docs/superpowers/plans/2026-05-20-keyframe-extraction-tutorial.md)
...
- **positional-debiasing** (2026-05-21) — [spec](docs/superpowers/specs/2026-05-20-positional-debiasing-design.md) · [plan](docs/superpowers/plans/2026-05-20-positional-debiasing.md)
...
- **feature-lifting** (2026-05-20) — [spec](docs/superpowers/specs/2026-05-20-feature-lifting-design.md) · [plan](docs/superpowers/plans/2026-05-20-feature-lifting.md)
...
- **semantics-refactor** (2026-05-20) — [plan](docs/superpowers/plans/2026-05-20-semantics-refactor.md)
