...
**Spec:** `worklog/history/specs/2026-04-16-pointcloud-submodule-design.md`
...
- [x] **Read the existing utils file**
...
- [x] **Create `collab_splats/pointcloud/__init__.py`** (empty for now)

```python
# collab_splats/pointcloud/__init__.py
```

- [x] **Create `collab_splats/pointcloud/base.py`**
...
- [x] **Create `collab_splats/pointcloud/utils.py`**
...
- [x] **Replace `collab_splats/utils/pointcloud.py` with re-export shim**
...
- [x] **Create `tests/pointcloud/__init__.py`** (empty)
...
- [x] **Create `collab_splats/pointcloud/sfm.py`**
...
- [x] **Read `stage/feedforward.py` to find the exact signature**
...
- [x] **Run non-GPU tests to confirm FAIL**

```bash
pytest tests/pointcloud/test_mapanything_creator.py -v -k "not gpu"
```

- [x] **Update `stage/feedforward.py`** — add `extractor` param to `feedforward_to_pointcloud()`
...
- [x] **Create `collab_splats/pointcloud/feedforward.py`**
...
- [x] **Run non-GPU tests to confirm PASS**
...
- [x] **Read `collab_splats/wrapper/splatter.py`** — find where pointcloud creation currently happens
...
- [x] **Implement `collab_splats/pointcloud/__init__.py`**
...
- [x] **Update `collab_splats/wrapper/splatter.py`**
...
- [x] **Run registry tests to confirm PASS**
